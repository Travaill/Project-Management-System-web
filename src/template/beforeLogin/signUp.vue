    ...
    <div class="sign-up">
        ...
        <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="100">
            ...
            <Form-item label="学号" prop="studentId">
                <Input type="text" v-model="formValidate.studentId" placeholder="student Id">
                <Icon type="ios-person-outline" slot="prepend"></Icon>
                </Input>
            </Form-item>
            <Form-item label="教务处密码" prop="password">
                <Input type="password" v-model="formValidate.jwch_password" placeholder="jwch_password">
                <Icon type="ios-locked-outline" slot="prepend"></Icon>
                </Input>
            </Form-item>
            <Form-item>
            ...
            this.$refs[name].validate((valid) => {
                if (valid) {
                    ...
                    this.axios.post('/index.php/User/name/1',{                      
                        ...
                        jwch_password: this.formValidate.jwch_password,
